...
exports.checkMaNVParamOwnershipOrManagerAdmin = exports.checkMaNVParamOwnership = exports.requireManagerOrAdmin = exports.checkMaNVOwnership = exports.checkAdminOrPass = exports.requireAdmin = void 0;
...
const requireAdmin = (req, res, next) => {
    ...
    if (!(0, authHelper_1.isAdminRole)(userRole)) {
...
const checkAdminOrPass = (req, res, next) => {
    const userRole = req.user?.userInfo?.role;
    req.isAdmin = (0, authHelper_1.isAdminRole)(userRole);
    next();
};
exports.checkAdminOrPass = checkAdminOrPass;
/**
...
const checkMaNVOwnership = (req, res, next) => {
    try {
        ...
        const isAdmin = (0, authHelper_1.isAdminRole)(userRole);
        console.log(`🔐 MaNV Ownership Check - Token MaNV: ${tokenMaNV}, Request MaNV: ${bodyMaNV}, isAdmin: ${isAdmin}`);
...
exports.checkMaNVOwnership = checkMaNVOwnership;
/**
...
const requireManagerOrAdmin = (req, res, next) => {
    const userRole = req.user?.userInfo?.role;
    const normalizedRole = (0, authHelper_1.normalizeRole)(userRole);
    if (normalizedRole !== "admin" && normalizedRole !== "quanly") {
        return res.status(403).json({
            success: false,
            message: "Bạn không có quyền truy cập tài nguyên này. Chỉ quản lý hoặc admin mới có thể.",
        });
    }
    next();
};
...
exports.checkMaNVParamOwnership = checkMaNVParamOwnership;
/**
...
exports.checkMaNVParamOwnershipOrManagerAdmin = checkMaNVParamOwnershipOrManagerAdmin;
